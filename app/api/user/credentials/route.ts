...
export async function POST(req: Request) {
  ...
  await prisma.userCredentials.upsert({
    where: { userId },
    update: {
      ...(encryptedApiKey && { anthropicApiKey: encryptedApiKey }),
      anthropicAuthType,
      ...(encryptedAuthToken && { anthropicAuthToken: encryptedAuthToken }),
      ...(encryptedOpenaiKey && { openaiApiKey: encryptedOpenaiKey }),
